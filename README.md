...
![Add Student Blank](Project_UI_Design/b69e77f9-f894-4e2b-b7ae-13230b68dbd1.png)

# 2. Admission Form (Filled Details)
Data entry for a new student record (e.g., Abdul Rauf).
![Add Student Filled](Project_UI_Design/2914ecb6-0da3-42b9-8ec3-553ae3ba7d2e.png)

# 3. Campus Directory Dashboard
The main table view showing all enrolled students with departmental badges.
![Directory Dashboard](Project_UI_Design/8724cd22-9be1-45d7-b388-bf611751276f.png)

# 4. Update Student Record
The edit interface populated with existing student data.
![Edit Student](Project_UI_Design/95b9152d-5e63-43d8-bed1-9e043c76f904.png)

# 5. Record Updated View
Dashboard view showing the updated student information.
![Updated Directory](Project_UI_Design/242c0bef-8a18-4bf7-877b-cc86238b090b.png)

# 6. Delete Confirmation Alert
JavaScript confirmation to prevent accidental deletion of records.
![Delete Confirmation](Project_UI_Design/556a81ed-add3-4b6a-b924-dc2723985b90.jpg)
